...
//      Change your code to assign the value 123L (Note the 'L' at the end) to myNumber.
            myNumber = 123L;
            System.out.println(myNumber);
            //THIS RAN THE VARIABLE MYNUMBER BUT THE OUTPUT WAS ONLY THE NUMBERS (123) NO 'L'. THIS WORKS DUE TO THE "L" BEING UTILIZED TO DECLARE THE NUMBER AS A LONG VALUE.
...
//      What happens if you assign a value to a numerical variable that is larger (or smaller) than the type can hold? What happens if you increment a numeric variable past the type's capacity?
            //THE COMPILER WILL THROW AN ERROR IF YOU ASSIGN A NUMERICAL VALUE THAT IS LARGER THAN THE TYPE THAT IS ASSIGNED CAN HOLD; IF YOU DESIGN IT TO SLIP PAST THE COMPILER AS AN OBJECT OR AS A CAST IT WILL CONTINUE TO ROLL OVER UNTIL FINISHED AND THEN DISPLAY WHATEVER THE FINAL NUMBER LANDED ON WAS. IF IT IS A SMALLER NUMERICAL VALUE THEN IT WILL RUN THE CODE.
            // DEPENDING ON THE DATA TYPE ASSIGNED, IT WILL REVERT BACK TO THE BEGINNING OF THAT DATA TYPE SET (ROLL OVER)-- BACK TO THE FIRST NEGATIVE NUMBER (AKA THE LOWEST NUMBER IN THE SET).
